...
pest_control_advice = {
    ...
    "稻纵卷叶螟": "可使用氯虫苯甲酰胺、甲氨基阿维菌素苯甲酸盐等药剂，在幼虫孵化高峰期喷雾。",
    "二化螟": "可使用杀虫双、三唑磷等药剂，或采用性诱剂诱杀成虫。",
    "棉铃虫": "可使用甲氨基阿维菌素苯甲酸盐、氯虫苯甲酰胺等药剂，在卵孵化盛期至低龄幼虫期喷雾。",
    "天牛": "可人工捕捉成虫，或用磷化铝片剂堵塞虫孔熏蒸幼虫，也可喷洒噻虫啉等药剂防治。",
    "蛴螬": "可使用毒死蜱、辛硫磷等药剂进行土壤处理，或在播种时拌种防治。"
}
